...
usrRoutr
  ...
  .post(
    [
      middleware.multer.single("prodImage"),
      middleware.mediaUpload.uploadSingleMediaToS3("prodImage"),
...
usrRoutr.route("/get_product").post(async function (req, res) {
...
usrRoutr.route("/place_order").post(async function (req, res) {
  console.log("Place order is working fine");
  let { productId, quantity, email } = req.body;
...
usrRoutr.route("/update_product").put(async function (req, res) {
...
usrRoutr.route("/delete_product").delete(async function (req, res) {
